# ProofVault: System Architecture

## Overview

The ProofVault application is a privacy-first DApp that leverages zero-knowledge proofs and end-to-end encryption to enable anonymous, secure reporting. The architecture follows a local-first approach with optional cloud synchronization, ensuring that sensitive data never leaves the client unencrypted.
...
- **TipsterPage**: 3-step anonymous submission flow
- **InvestigatorPage**: Key management and report decryption
